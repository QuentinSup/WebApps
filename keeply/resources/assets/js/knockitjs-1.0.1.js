...
(function (kit) {
    var fields;
    (function (fields) {
        var PasswordUIField = (function (_super) {
            __extends(PasswordUIField, _super);
            function PasswordUIField(id, value, required, readOnly) {
                _super.call(this, id, value, required, readOnly);
                this.inputTemplate = "ui-field-password-template";
            }
            return PasswordUIField;
        })(fields.TextUIField);
        fields.PasswordUIField = PasswordUIField;
    })(fields = kit.fields || (kit.fields = {}));
})(kit || (kit = {}));
var kit;
(function (kit) {
