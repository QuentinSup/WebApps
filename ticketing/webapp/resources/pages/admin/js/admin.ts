    ...
    class UserForm {
        ...
        public constructor(parent: any) {
            ...
            this.isPassword1Valid = ko.computed((): boolean => {
                ...
                return UserModel.isPasswordStrengthOK(v);  
            }).extend({ throttle: 100 });
        ...
        public verifyUserName(): boolean {
            ...
            this.user.isNameUnique(this.name(), (b: boolean): void => {
        ...
        public verifyUserEmail(): boolean {
            ...
            this.user.isEmailUnique(this.email(), (b: boolean): void => {
